...
TEST_FLIGHT_LIST = [
    ...
    ('oval', 'Forward', 3.),
    ('oval', 'Forward', 4.),
    ('patrick', 'Forward', 0.5),       # 30
    ('patrick', 'Forward', 1.),
    ('patrick', 'Forward', 2.),
    ('patrick', 'Forward', 3.),
    ('patrick', 'Forward', 4.),
    ('picasso', 'Forward', 0.5),       # 35
    ('picasso', 'Forward', 1.),
    ('picasso', 'Forward', 3.),
    ('picasso', 'Forward', 4.),
    ('picasso', 'Forward', 5.),
    ...
    ('figure8', 'Constant', 1.),
    ('figure8', 'Constant', 2.),
    ('figure8', 'Constant', 3.25),     # 95  # ('figure8', 'Constant', 3.),
    ('figure8', 'Constant', 5.),
    ('halfMoon', 'Constant', 1.),
    ('halfMoon', 'Constant', 2.),
    ('halfMoon', 'Constant', 3.),
    ('halfMoon', 'Constant', 4.),      # 100
    ('mouse', 'Constant', 1.),
    ('mouse', 'Constant', 2.),
    ('mouse', 'Constant', 3.),
    ('mouse', 'Constant', 4.),
    ('mouse', 'Constant', 5.),         # 105
    ('mouse', 'Constant', 6.),
    ('mouse', 'Constant', 7.),
    ('oval', 'Constant', 2.),
    ('oval', 'Constant', 3.),
    ...
    ('patrick', 'Constant', 3.),
    ('patrick', 'Constant', 4.),
    ('patrick', 'Constant', 5.),       # 115
    ('picasso', 'Constant', 0.5),
    ('picasso', 'Constant', 1.),
    ('picasso', 'Constant', 2.),
    ('picasso', 'Constant', 3.),
    ('picasso', 'Constant', 4.),       # 120
    ('picasso', 'Constant', 5.),
    ('picasso', 'Constant', 6.),
    ('sid', 'Constant', 1.),
    ('sid', 'Constant', 2.),
    ...
    ('star', 'Constant', 5.),
    ('thrice', 'Constant', 1.),
    ('thrice', 'Constant', 2.),        # 140
    ('thrice', 'Constant', 3.),
    ('thrice', 'Constant', 4.),
    ('thrice', 'Constant', 5.),
    ('thrice', 'Constant', 6.),
    ('thrice', 'Constant', 7.),        # 145
    ('tiltedThrice', 'Constant', 1.),
    ('tiltedThrice', 'Constant', 2.),
    ('tiltedThrice', 'Constant', 3.),
    ('tiltedThrice', 'Constant', 4.),
    ('tiltedThrice', 'Constant', 5.),  # 150
    ('tiltedThrice', 'Constant', 6.),
    ('tiltedThrice', 'Constant', 7.),
    ('winter', 'Constant', 1.),
    ('winter', 'Constant', 2.),
    ('winter', 'Constant', 3.),        # 155
    ('winter', 'Constant', 4.),
    ('winter', 'Constant', 5.)
]

DEFAULT_SEQUENTIAL_TRAINING_LIST = [
    TEST_FLIGHT_LIST.index(x) for x in [
        ...
        ('clover', 'Constant', 6.0),
        ('dice', 'Constant', 4.0),
        ('halfMoon', 'Forward', 4.0),
        ('mouse', 'Constant', 3.0),
        ('mouse', 'Constant', 7.0),
        ('oval', 'Constant', 3.0),
        ('oval', 'Forward', 1.0),
        ('oval', 'Forward', 3.0),
        ('picasso', 'Constant', 6.0),
        ('sid', 'Constant', 7.0),
        ('sphinx', 'Constant', 4.0),
        ('star', 'Forward', 5.0),
        ('ampersand', 'Forward', 1.0),
        ('halfMoon', 'Forward', 1.0),
        ('tiltedThrice', 'Forward', 3.0),
        ('mouse', 'Forward', 5.0),
        ('picasso', 'Forward', 0.5),
        ('thrice', 'Forward', 0.5),
        ('sphinx', 'Forward', 1.0),
        ...
        ('clover', 'Forward', 2.0),
        ('thrice', 'Constant', 6.0),
        ('tiltedThrice', 'Constant', 2.0),
        ('figure8', 'Constant', 1.0),
        ('figure8', 'Constant', 3.25),
        ('thrice', 'Forward', 1.0),
        ('tiltedThrice', 'Constant', 4.0),
        ('halfMoon', 'Forward', 2.0),
        ('sid', 'Constant', 4.0),
        ('mouse', 'Constant', 6.0),
        ('bentDice', 'Constant', 1.0),
        ('patrick', 'Constant', 4.0),
        ('sphinx', 'Forward', 4.0),
        ('tiltedThrice', 'Forward', 1.0),
        ('oval', 'Constant', 4.0),
        ('sid', 'Forward', 3.0),
        ('figure8', 'Constant', 5.0),
        ('tiltedThrice', 'Constant', 3.0),
        ('patrick', 'Constant', 1.0),
        ...
        ('patrick', 'Forward', 0.5),
        ('patrick', 'Constant', 2.0),
        ('thrice', 'Constant', 2.0),
        ('dice', 'Constant', 2.0),
        ('dice', 'Forward', 3.0),
        ('thrice', 'Constant', 4.0),
        ('bentDice', 'Constant', 4.0),
        ('star', 'Constant', 1.0),
        ('halfMoon', 'Forward', 3.0),
        ('mouse', 'Constant', 4.0),
        ('thrice', 'Forward', 3.0),
        ('winter', 'Forward', 0.5),
        ('picasso', 'Constant', 2.0),
        ('sid', 'Forward', 1.0),
        ('tiltedThrice', 'Forward', 4.0),
        ('thrice', 'Constant', 1.0),
        ('star', 'Forward', 4.0),
        ('sid', 'Forward', 4.0),
        ('mouse', 'Forward', 1.0),
        ('picasso', 'Constant', 5.0),
        ('thrice', 'Constant', 3.0),
        ('star', 'Constant', 4.0),
        ('winter', 'Constant', 4.0),
        ('bentDice', 'Constant', 3.0),
        ('3dFigure8', 'Constant', 5.0),
        ('tiltedThrice', 'Constant', 1.0),
        ('3dFigure8', 'Constant', 4.0),
        ('clover', 'Forward', 4.0),
        ('sid', 'Constant', 1.0),
        ('figure8', 'Constant', 2.0),
        ('tiltedThrice', 'Constant', 6.0),
        ('picasso', 'Constant', 3.0),
        ('star', 'Forward', 1.0),
        ('patrick', 'Forward', 2.0),
        ('mouse', 'Forward', 7.0),
        ('thrice', 'Constant', 7.0),
        ('tiltedThrice', 'Forward', 6.0),
        ('sphinx', 'Constant', 2.0),
        ('patrick', 'Constant', 5.0),
...
DEFAULT_TESTING_LIST = [
    TEST_FLIGHT_LIST.index(x) for x in [
        ...
        ('figure8', 'Constant', 0.5),
        ('mouse', 'Constant', 2.0),
        ('tiltedThrice', 'Forward', 5.0),
        ('halfMoon', 'Constant', 2.0),
        ('sphinx', 'Forward', 3.0),
        ('picasso', 'Constant', 1.0),
        ('patrick', 'Forward', 4.0),
        ('dice', 'Forward', 1.0),
        ('picasso', 'Forward', 1.0),
        ('star', 'Forward', 3.0),
        ...
        ('winter', 'Constant', 2.0),
        ('sid', 'Constant', 2.0),
        ('patrick', 'Constant', 3.0),
        ('star', 'Constant', 2.0),
        ('ampersand', 'Forward', 2.0),
        ('sid', 'Constant', 3.0),
        ('winter', 'Constant', 5.0)
    ]
]
